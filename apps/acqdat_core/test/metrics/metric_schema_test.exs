defmodule AcqdatCore.Schema.MetricsTest do
  ...
  describe "changeset" do
    ...
    test "metrics - successfully updates database" do
      ...
      changeset = Metrics.changeset(%Metrics{}, %{inserted_time: time, metrics: params})
  ...
  defp dummy_data() do
    ...
    data_insights: %{
      ...
      visualisations: %{count: 2, metadata: %{data: [%{id: 63, value: "1"}, %{id: 64, value: "2"}]}}
    },
    entities: %{
      ...
      assets: %{
        count: 2,
        metadata: %{data: [%{id: "VSUN 5-30 V1", value: 195}, %{id: "Power Cube 10-100", value: 214}]}
      },
      gateways: %{
        count: 2,
        metadata: %{
          data: [%{id: "Gateway Cleantech 10-100", value: 47}, %{id: "VSUN V1 5-30 Gateway", value: 28}]
        }
      },
      projects: %{count: 1, metadata: %{data: [%{id: 70, value: "JTC Cleantech 1"}]}},
      sensor_types: %{
        count: 2,
        metadata: %{data: [%{id: 54, value: "PowerCubePramsV1"}, %{id: 51, value: "PowerCubeParams"}]}
      },
      sensors: %{
        count: 4,
        metadata: %{
